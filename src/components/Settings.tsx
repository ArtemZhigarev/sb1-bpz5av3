...
import { X, Save, RefreshCw, Database, Table, Trash2, MessageCircle, AlertCircle, Moon, Sun, Clock } from 'lucide-react';
...
export const Settings: React.FC<SettingsProps> = ({ onClose }) => {
  ...
  const [activeTab, setActiveTab] = useState<'airtable' | 'telegram' | 'appearance'>('airtable');
